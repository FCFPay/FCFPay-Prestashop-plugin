 ...
 * @since 1.5.0
 */
class FcfPayCronModuleFrontController extends ModuleFrontController
{
    public function postProcess()
    {
        ...
        $unpaid_orders = $db->executeS("SELECT `id_order`,`order_reference` FROM `"._DB_PREFIX_."fcfpay_orders` WHERE `status` != 'paid'");
